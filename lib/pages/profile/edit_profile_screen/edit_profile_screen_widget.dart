                            ...
                            Stack(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Image.memory(
                                    _model.uploadedLocalFile_uploadData3zd
                                            .bytes ??
                                        Uint8List.fromList([]),
                                    fit: BoxFit.contain,
                                    errorBuilder:
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (selectedMedia != null &&
                                      ...
                                      safeSetState(() =>
                                          _model.isDataUploading_uploadData3zd =
                                              true);
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    // 2. Pegar os novos dados dos controllers
                    // (Lembrando que textController1 é 'Primeiro nome' e textController2 é 'Sobrenome')
                    final newFirstName = _model.textController1.text;
                    final newLastName = _model.textController2.text;

                    // 3. Pegar o ID do usuário logado (que salvamos no AppState)
                    final id = FFAppState().userId;

                    // 4. Chamar a função de Update do Banco de Dados
                    // (A 'updateUserDetails' que acabamos de corrigir)
                    int rowsAffected = await DatabaseHelper()
                        .updateUserDetails(id, newFirstName, newLastName);

                    if (rowsAffected > 0) {
                      // SUCESSO! O banco de dados foi atualizado.
                      
                      // 5. ATUALIZAR o AppState também!
                      // (Senão, o usuário voltará para a tela de perfil e verá os nomes antigos)
                      FFAppState().update(() {
