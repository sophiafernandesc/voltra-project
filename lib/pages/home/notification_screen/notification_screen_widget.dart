          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: Builder(
                  builder: (context) {
                    final ntList = FFAppState().notificationList.toList();
                    ...
                    return ListView.separated(
                      ...
                      itemCount: ntList.length,
                      separatorBuilder: (_, __) => SizedBox(height: 16.0),
                      itemBuilder: (context, ntListIndex) {
                        final ntListItem = ntList[ntListIndex];
                        return Padding(
                                              ...
                                              Expanded(
                                                child: Text(
                                                  valueOrDefault<String>(
                                                    ntListIndex.toString(),
                                                    'Visualize sua notificação aqui.',
                                                  ),
                                                  maxLines: 1,
